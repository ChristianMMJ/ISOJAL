...
<!--                    <img src="img/avatar_hat.jpg" class="w3-round w3-image w3-opacity w3-hover-opacity-off" alt="Photo of Me" width="500" height="333">-->
            ...
            <p class="w3-large w3-justify w3-padding-16">TIPOS DE ACTIVIDADES REALIZADAS</p>
            <p class="w3-wide"><i class="far fa-smile"></i> Proyectos De valor agregado</p>
            <div class="w3-light-grey">
                <div class="w3-container w3-padding-small w3-dark-grey w3-justify" style="width:100%">100%</div>
            </div>
            <p class="w3-wide"><i class="fas fa-industry"></i> Elaboración de productos lácteos</p>
            <div class="w3-light-grey">
                <div class="w3-container w3-padding-small w3-dark-grey w3-justify" style="width:100%">100%</div>
            </div>
            <p class="w3-wide"><i class="fab fa-leanpub"></i> Talleres y Foros de Capacitación</p>
            <div class="w3-light-grey">
                <div class="w3-container w3-padding-small w3-dark-grey w3-justify" style="width:100%">100%</div>
            </div>
        </div>
